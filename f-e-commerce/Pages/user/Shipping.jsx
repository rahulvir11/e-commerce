...
const handlSubmit = async (e) => {
  ...
  return (
    <section className="w-screen  bg-gray-50 dark:bg-gray-900 box-border gap-10 px-[4%] md:flex items-center justify-center overflow-hidden">
      <div className=" w-[98vw] md:w-1/2 xl:w-[35%] bg-white rounded-lg shadow dark:border md:mt-0  xl:p-0 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div>
        <table className="w-full  text-center" cellPadding="5">
          <thead>
